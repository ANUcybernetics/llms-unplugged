...
// greedy max-min OKLab ΔE selection. N=20 chromatic + black + mid-grey =
// 22 swatches. Min pairwise OKLab ΔE = 0.152, which sits in the "generously
...
// Regenerate with: node cli/scripts/generate_palette.ts --n 20
#let palette = (
