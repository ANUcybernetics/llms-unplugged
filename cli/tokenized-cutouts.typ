...
// greedy max-min OKLab ΔE selection. N=24 chromatic + black + mid-grey =
// 26 swatches. Min pairwise OKLab ΔE = 0.143, which sits in the "generously
...
// next word. Trade-off: white-on-fill contrast is no longer uniform — the
// light (L>70%) entries give poor contrast for previous-word boxes, and as
// free-standing text on white the light entries are fainter.
// Regenerate with: node cli/scripts/generate_palette.ts --n 24
#let palette = (
  // Neutrals (seeded into the greedy search)
  luma(0), // black
  luma(140), // mid grey

  // Chromatic (sorted by hue)
  oklch(62.9%, 0.256, 27deg),
  oklch(41.7%, 0.170, 28deg),
  oklch(30.4%, 0.080, 39deg),
  oklch(85.0%, 0.083, 41deg),
  oklch(55.5%, 0.148, 47deg),
  oklch(68.4%, 0.139, 83deg),
  oklch(84.5%, 0.177, 103deg),
  oklch(32.6%, 0.103, 140deg),
  oklch(63.3%, 0.213, 142deg),
  oklch(84.9%, 0.288, 142deg),
  oklch(48.2%, 0.151, 144deg),
  oklch(84.7%, 0.121, 163deg),
  oklch(69.6%, 0.086, 166deg),
  oklch(75.4%, 0.152, 232deg),
  oklch(42.0%, 0.131, 254deg),
  oklch(44.8%, 0.309, 264deg),
  oklch(60.4%, 0.201, 270deg),
  oklch(83.2%, 0.088, 288deg),
  oklch(50.1%, 0.252, 310deg),
  oklch(30.1%, 0.142, 318deg),
  oklch(70.8%, 0.126, 323deg),
  oklch(69.9%, 0.320, 329deg),
  oklch(45.3%, 0.121, 330deg),
  oklch(57.4%, 0.240, 348deg),
)
