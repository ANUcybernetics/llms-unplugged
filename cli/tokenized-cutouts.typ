...
// 30 swatches. Min pairwise OKLab ΔE = 0.145, which sits in the "generously
// distinct" range (≥0.10 is "clearly distinct"; print reproduction loses
// 0.02–0.05 of ΔE through CMYK conversion, paper colour, and ambient
// light, so we want headroom). Black and mid-grey are seeded as search
// anchors so chromatic colours can't collapse onto the greyscale axis.
...
// Regenerate with: node cli/scripts/generate_palette.ts --n 28
#let palette = (
  ...
  (color: oklch(29.9%, 0.121, 28deg), light: false),
  (color: oklch(47.6%, 0.166, 35deg), light: false),
  ...
  (color: oklch(37.3%, 0.125, 142deg), light: false),
  (color: oklch(67.1%, 0.227, 143deg), light: true),
  (color: oklch(52.7%, 0.162, 146deg), light: false),
  (color: oklch(75.9%, 0.078, 151deg), light: true),
  (color: oklch(81.2%, 0.214, 151deg), light: true),
  (color: oklch(20.4%, 0.052, 153deg), light: false),
  (color: oklch(90.4%, 0.149, 187deg), light: true),
  (color: oklch(73.7%, 0.158, 236deg), light: true),
  (color: oklch(34.8%, 0.055, 248deg), light: false),
  (color: oklch(46.0%, 0.159, 257deg), light: false),
  (color: oklch(43.9%, 0.302, 264deg), light: false),
  (color: oklch(27.5%, 0.188, 264deg), light: false),
  (color: oklch(66.1%, 0.190, 288deg), light: true),
  (color: oklch(51.4%, 0.292, 289deg), light: false),
  (color: oklch(20.7%, 0.099, 305deg), light: false),
  (color: oklch(34.3%, 0.165, 315deg), light: false),
  (color: oklch(90.4%, 0.084, 328deg), light: true),
  (color: oklch(69.9%, 0.320, 329deg), light: true),
  (color: oklch(48.6%, 0.213, 338deg), light: false),
  (color: oklch(71.1%, 0.118, 346deg), light: true),
  (color: oklch(62.3%, 0.256, 352deg), light: false),
)
