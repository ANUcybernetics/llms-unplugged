--- title: LLMs Unplugged (Fundamentals) description: A Cybernetic Studio
workshop --- ## Icebreaker ![bg
...
pre-training - foundation model --- ## Reflection ![bg
right:60%](../assets/bg-randomness.avif) - how has this workshop changed how you
**think** about language models? - how has this workshop changed how you will
**use** language models? ---

<!-- _class: impact -->

[www.llmsunplugged.org](https://www.llmsunplugged.org) --- # Q&A ![bg
right:60%](../assets/bg-participants.avif) ---
