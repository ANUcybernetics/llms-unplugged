...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.7em;">
  ...
  <div style="display: flex; align-items: center; gap: 0.6em;">
    <img src="/src/decks/assets/cards/hero-more-context.avif" style="height: 5.5em; border-radius: 6px;" alt="More Context" />
    <p>More Context</p>
  </div>
  <div style="display: flex; align-items: center; gap: 0.6em;">
  ...
  <div style="display: flex; align-items: center; gap: 0.6em;">
    <img src="/src/decks/assets/cards/hero-in-context-memory.avif" style="height: 5.5em; border-radius: 6px;" alt="In-context Memory" />
    <p>In-context Memory</p>
  </div>
  <div style="display: flex; align-items: center; gap: 0.6em;">
    <img src="/src/decks/assets/cards/hero-induction-heads.avif" style="height: 5.5em; border-radius: 6px;" alt="Induction Heads" />
    <p>Induction Heads</p>
  </div>
  <div style="display: flex; align-items: center; gap: 0.6em;">
...
![bg right:60%](./assets/bg-div-quote-portrait.avif)
