...
| <Token next tool>FRIEND</Token> | everyone texts a friend the sentence so far | first reply wins          |

{/* notes:
Two tools: GOOGLE = search on a phone, read the first word of the top hit; FRIEND = everyone texts a friend the sentence so far, first reply wins. Swap in your own if you like.
*/}
