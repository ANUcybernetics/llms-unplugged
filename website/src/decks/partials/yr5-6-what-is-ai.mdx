...
Type your name and the three words into the boxes on this slide, hit "Copy prompt", then alt-tab to ChatGPT and paste. Year 5 and Canberra are baked into the prompt --- edit STORY_PROMPT in cutouts-yr5-6.deck.mdx if this delivery differs.
