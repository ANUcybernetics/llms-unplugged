...
<!-- @include ./partials/ack-country.md -->

---

<!-- @include ./partials/presenters.md -->

---

<!-- @include ./partials/icebreaker.md -->
...
<!-- @include ./generation.md -->

---

<!-- @include ./pretrained-generation.md -->
