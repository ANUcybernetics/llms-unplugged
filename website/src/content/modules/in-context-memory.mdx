...
![](../../assets/images/hero-in-context-memory.avif)

## You will need

- any model you can already generate from: your [bigram grid](/modules/training/),
  a [cutouts spread](/modules/generation/), or a
  [pre-trained booklet](/modules/pretrained-generation/)
- pen and paper for your generated text
- dice (or a coin) as per [Generation](/modules/generation/)

This module adds a procedure on top of a model you already have---there's
...
- how is this different from the [trigram](/modules/more-context/), which also
