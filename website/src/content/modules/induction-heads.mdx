...
![](../../assets/images/hero-induction-heads.avif)
...
Like [In-context Memory](/modules/in-context-memory/), this is a procedure laid
...
The [In-context Memory](/modules/in-context-memory/) module boosted _recently
...
the memory module: blend, don't override.
...
- how is induction different from the [recency memory](/modules/in-context-memory/)?
