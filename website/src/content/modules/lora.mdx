...
<GlossaryTerm id="lora">Low-Rank Adaptation (LoRA)</GlossaryTerm> stores only
...
2. Train a LoRA grid:
   ...
   - Run [Training](/modules/training/) (grid method) on your new domain text,
