...
1. **Generate synthetic text:** use your existing model to create 50–100+ words
   (as in [Generation](/modules/generation/)). This is your synthetic corpus.
2. **Train generation 2:** build a new model using the
   [Training](/modules/training/) algorithm with the synthetic corpus.
3. **Compare models:**
...
<GlossaryTerm id="model-collapse">Model collapse</GlossaryTerm> from synthetic
