...
The LLMs Unplugged brand mark encodes the five tokens in the project's name as
dot patterns.
...
tokenisers encode word boundaries.
...
<img
  src="/favicon.svg"
  alt="The LLMs Unplugged favicon---animated dot patterns cycling through all five title tokens"
  style="max-width: 120px; margin: 1.5rem auto; display: block;"
/>
...
Every dot pattern on the site is a real token ID rendered the same way.
...
<img
  src="/favicon-5up.svg"
  alt="All five LLMs Unplugged title tokens shown side by side as 4×4 dot grids in uniform gold"
  style="max-width: 400px; margin: 1.5rem auto; display: block;"
/>
...
<img
  src="/favicon-5up-tinted.svg"
  alt="All five LLMs Unplugged title tokens shown side by side as 4×4 dot grids with per-token tinted backgrounds"
  style="max-width: 400px; margin: 1.5rem auto; display: block;"
/>
...
<img
  src="/lockup.svg"
  alt="The LLMs Unplugged horizontal lockup---the 4x4 dot grid with the title set beside it"
  style="max-width: 320px; margin: 1.5rem auto; display: block;"
/>
...
carries its own letterforms and renders identically as an `<img>`, in print, or
...
The animation scales to its container without pixel breakpoints or resize
listeners.
