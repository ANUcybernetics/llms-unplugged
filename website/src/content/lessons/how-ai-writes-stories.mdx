...
School](/news/2026-06-02-how-ai-writes-stories-at-duffy/) with three year 5-6
classes.
...
- printed token cutouts (bigram, i.e. `-n 2`) from two or three picture
  books---the [Tools](/tools/#cutouts) page has ready-to-print packs for
  _Green Eggs and Ham_, _Where Is the Green Sheep?_, and _We're Going on a
  Bear Hunt_, or you can [generate your own](/tools/#generate-your-own)
...
- have a few predict-the-next-word prompts ready for the whiteboard; ones the
  class will finish instantly work best (the school's own values, "yer a
  wizard, **\_\_**!")
...
<UsingTheSlides
  decks={[{ slug: "cutouts-yr5-6", label: "How AI writes stories (90 min)" }]}
/>
