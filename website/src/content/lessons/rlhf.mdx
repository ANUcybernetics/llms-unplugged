...
- **<GlossaryTerm id="claude">Claude</GlossaryTerm>, <GlossaryTerm id="chatgpt">ChatGPT</GlossaryTerm>, and others**: all use RLHF to align model outputs with human values
