...
description: Turn each word's row into a vector and measure similarities between words in
  your model.
order: 8
topic: how-models-understand
keyIdea: A word's row in the grid is its embedding; distances between rows reveal
...
- your completed [bigram grid](/lessons/training)
