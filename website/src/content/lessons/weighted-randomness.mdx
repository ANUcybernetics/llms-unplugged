...
description: Learn how to make random choices where some options are more likely than
  others---a core generative AI operation.
order: 0
topic: fundamentals
keyIdea: Use weighted sampling to make random choices that reflect a target probability
  distribution.
---
