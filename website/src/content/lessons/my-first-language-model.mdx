...
- **90 minutes and up:** a pre-trained model booklet---the
  [Tools](/tools/#booklets-for-dice-generation) page has ready-to-print
...
<UsingTheSlides
  decks={[
    { slug: "grid-60min", label: "My First Language Model (60 min)" },
    { slug: "grid-90min", label: "My First Language Model (90 min)" },
    { slug: "grid-2h", label: "My First Language Model (2 hours)" },
  ]}
/>
