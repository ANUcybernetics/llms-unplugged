...
import BucketGenerationWidget from "../../components/widgets/BucketGenerationWidget.svelte";
...
<LmBuckets tokens="see spot run . see spot jump ." />
...
<BucketGenerationWidget client:visible />
