...
description:
  ...
  combine them, break them (sycophancy), extend them with tools, and finish
  with a poetry slam.
...
you're thinking of running it, [get in touch](/about/#get-in-touch) and we'll
...
- printed token cutouts for several texts (bigram, `-n 2`)---see the
  [Tools](/tools/#cutouts) page for ready-to-print packs, and the sycophancy
