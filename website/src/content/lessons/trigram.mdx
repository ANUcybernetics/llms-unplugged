...
7. **Stop** when you've generated enough text, or when no cutouts match your
   last two words
8. If no cutout matches both previous words, settle for one where just the
   rightmost previous-word box matches your most recent word---you've fallen
   back to bigram matching for that step. The model never saw your exact pair
   during training; this is the data sparsity problem in action
...
- what happens when you encounter a two-word combination you've never seen
  before?
