...
The [Tools](/tools#cutouts-for-bucket-training) page has ready-to-print trigram
token cutouts, or you can
...
Build a <GlossaryTerm id="trigram-model">trigram language model</GlossaryTerm> using buckets where each bucket is labelled with
