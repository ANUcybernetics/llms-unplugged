...
run paid workshops using these materials under the
[CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) license.
If you're a commercial training provider interested in using these resources,
please [contact us](/about/#get-in-touch)---we're happy to discuss alternative
