...
description: Use your hand-built bigram model to generate new text through weighted random sampling.
---

# Basic Generation

::: info Lesson Info
This lesson is part of the [Fundamentals](/topics/fundamentals) topic, with instructions for students (including examples) and [instructor notes](#instructor-notes). If you'd like a printable version of the student handout, [download it here](/assets/pdfs/basic-generation.pdf).
:::
