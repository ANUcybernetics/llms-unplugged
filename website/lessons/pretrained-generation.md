...
::: info Download pre-trained model booklets

While it's fun to upload your own documents to create your very own language
model using the online [model booklet generator](/tools#pdf-generator) here are
