...
- How language models learn patterns from text (training)
- How models generate new text (inference/generation)
- Why the same model can produce different outputs each time
- The fundamental mechanism behind ChatGPT-style AI systems
