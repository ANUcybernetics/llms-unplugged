...
const RSS_OPTIONS: RSSOptions = {
  ...
  description: 'Ready-to-use teaching resources for understanding how large language models work through hands-on activities.',
  language: 'en-AU',
  author: {
    name: 'Ben Swift',
...
export default defineConfig({
  title: 'LLMs Unplugged',
  description: 'Ready-to-use teaching resources for understanding how large language models work through hands-on activities. No computers required.',

  // Use clean URLs (no .html extension)
  cleanUrls: true,

  // Exclude non-content files
  srcExclude: ['**/README.md', '**/AGENTS.md', '**/CLAUDE.md', '**/LICENSE'],
  ...
  head: [
    ...
    // RSS feed
    ['link', { rel: 'alternate', type: 'application/rss+xml', title: 'LLMs Unplugged RSS Feed', href: '/feed.rss' }],
    // Google Fonts: Public Sans
    ['link', { rel: 'preconnect', href: 'https://fonts.googleapis.com' }],
    ['link', { rel: 'preconnect', href: 'https://fonts.gstatic.com', crossorigin: '' }],
    ['link', { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Public+Sans:ital,wght@0,300..900;1,300..900&display=swap' }],
    // Open Graph
    ['meta', { property: 'og:type', content: 'website' }],
    ['meta', { property: 'og:site_name', content: 'LLMs Unplugged' }],
    ['meta', { property: 'og:image', content: 'https://www.llmsunplugged.org/og-image.jpg' }],
    // Twitter
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:image', content: 'https://www.llmsunplugged.org/og-image.jpg' }],
  ],
  ...
  themeConfig: {
      ...
      '/lessons/': [
        {
          ...
          items: [
            ...
            { text: 'Weighted Randomness', link: '/lessons/weighted-randomness' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Pretrained Generation', link: '/lessons/pretrained-generation' },
          ]
        },
        {
      ...
      '/topics/': [
        {
          ...
          items: [
            ...
            { text: 'How Models Understand', link: '/topics/how-models-understand' },
            { text: 'Adaptation and Data', link: '/topics/adaptation-and-data' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/ANUcybernetics/llms-unplugged' }
    ],

    footer: {
      message: 'Released under CC BY-NC-SA 4.0 License.',
      copyright: '© Ben Swift · A Cybernetic Studio project at the ANU School of Cybernetics'
    },
