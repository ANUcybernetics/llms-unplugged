...
Implemented by removing `logos: ("studio",)` from the ANU template config and
adding custom branding directly in the page background. The text "LLMs Unplugged
| Cybernetic Studio" now appears in the left margin of all module cards,
matching the original positioning and styling (Neon Tubes 2 font, socy-yellow
colour, rotated -90deg).
